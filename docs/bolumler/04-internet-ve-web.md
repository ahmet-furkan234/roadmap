...
- [BTK Akademi — Ağ ve İnternet Temelleri](https://www.btkakademi.gov.tr/) — BTK Akademi'de "internet" veya "ağ" ara. HTTP, DNS, IP gibi konuları derinlemesine anlatan ücretsiz Türkçe kurslar var.
- [Yazılım Bilimi](https://www.youtube.com/@YazilimBilimiAnkara) — Web teknolojileri ve internetin nasıl çalıştığına dair Türkçe videolar.
